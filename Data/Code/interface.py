...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setGeometry(QtCore.QRect(380, 290, 131, 21))
        ...
        self.conglbl.setGeometry(QtCore.QRect(380, 320, 131, 21))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.SelectBtn.setText(_translate("MainWindow", "Pilih Citra MRI-Scan"))
        self.SelectBtn_2.setText(_translate("MainWindow", "DETEKSI"))
        self.label_2.setText(_translate("MainWindow", "Sistem Pendeteksi Diabetic Retinopathy"))
    ...
    def Deteksi(self):
        ...
        vgg16=load_model('MODELS/efficientnetb7.h5')
        ...
        if result==0:
                ...
                #self.label_2.setText(preds)
                cv2.imshow("Normal", img2)
        elif result==1:
                print("Terindikasi Brain Tumor")
                self.label.setText("Terindikasi Brain Tumor")
                #self.label_2.setText(preds)
                Hasil=Watershed(img2)
